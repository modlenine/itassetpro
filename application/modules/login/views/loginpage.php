				...
				<div class="col-md-6 col-lg-5">
					<div class="login-box bg-white box-shadow border-radius-10">
						<div class="login-title">
							<h2 class="text-center text-primary">IT-Asset PRO</h2>
						</div>
						<?php echo $this->session->flashdata('msg');?>
						<form id="frm_login" method="post" action="<?=base_url('login/checklogin')?>" autocomplete="off">
							...
							<div class="row">
								<div class="col-sm-12">
									<div class="input-group mb-0">
										...
										-->
										<button type="submit" id="btn_login" class="btn btn-primary btn-lg btn-block" >Sign In</button>
									</div>
								</div>
							</div>
						</form>
